...
export class Clients extends PureComponent {
  ...
  onAction(mac, action, athName, wirelessType) {
    const subData = {
      action,
      macs: [
        mac,
    ...
    if (typeof athName === 'string') {
      subData.athName = athName;
    }
          ...
          <div className="action-btns">
            {
              isLock ? (
                <Button
                  ...
                  onClick={this.onAction.bind(this, mac, 'unlock', item.get('athName'))}
                />
              ) : (
                <Button
                  icon="lock"
                  ...
                  text={msg.lock}
                  style={styles.actionButton}
                  onClick={this.onAction.bind(this, mac, 'lock', item.get('athName'))}
                />
              )
            }
            ...
            <Button
              ...
              text={msg.reconnect}
              style={styles.actionButton}
              onClick={this.onAction.bind(this, mac, 'reconnect', item.get('athName'))}
            />
          </div>
        );
      }.bind(this)
        ...
        render: function (val, item) {
          ...
          return (
            <Button
              ...
              text={msg.unlock}
              style={styles.actionButton}
              onClick={this.onAction.bind(this, deviceMac, 'unlock', item.get('athName'), item.get('wirelessType'))}
            />
          );
        }.bind(this),
      },
