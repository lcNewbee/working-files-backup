...
export default class LanSettings extends React.Component {
...
LanSettings.propTypes = propTypes;
LanSettings.defaultProps = defaultProps;

function mapStateToProps(state) {
  return {
    app: state.app,
    store: state.settings,
    selfState: state.lansettings,
  };
}
...
export const lansettings = reducer;
