        ...
        routes: [
          ...
          },
          {
            ...
            routes: [
              ...
              //     {
              //       id: 'radiusTemplate',
              //       path: '/main/portal/aaa/radius/template',
              //       formUrl: 'goform/network/radius/template',
              //       text: __('Radius Profiles'),
              //       component: sRadiusTemplate.Screen,
              //     },
              //     {
              //       id: 'portalRadiusNas',
              //       path: '/main/portal/aaa/radius/nas',
              //       formUrl: 'goform/portal/radius/nas',
              //       text: __('Local Radius Services'),
              //       component: sPortalNas.Screen,
              //     },
              //     // {
              //     //   id: 'radiusProxy',
              //     //   path: '/main/portal/aaa/radius/proxy',
              ...
              //       text: __('Service Provider Profiles'),
              ...
              // },
              {
                id: 'portalServices',
                isIndex: true,
                path: '/main/portal/server',
                icon: 'user-o',
                text: __('Local Server'),
                routes: [
                  {
                    id: 'portalRadiusNas',
                    path: '/main/portal/server/radius',
                    formUrl: 'goform/portal/radius/nas',
                  ...
                  },
                  {
                    id: 'portalAccess',
                    isIndex: true,
                    path: '/main/portal/server/portal',
                    ...
                    routes: [
                      {
                        id: 'portalAccessBase',
                        path: '/main/portal/server/portal/config',
                      ...
                      },
                      {
                        ...
                        path: '/main/portal/server/portal/ssidmanagement',
                        formUrl: 'goform/portal/access/ssidmanagement',
                        text: __('Pop-up Rules'),
                        component: sPortalSsid.Screen,
                      },
                      {
                        id: 'portalWechat',
                        path: '/main/portal/server/portal/weixin',
                      ...
                      {
                        id: 'portalFacebook',
                        path: '/main/portal/server/portal/facebook',
                      ...
                      {
                        id: 'portaSMSGateWay',
                        path: '/main/portal/server/portal/smsgateWay',
                      ...
                      {
                        id: 'portalAccessWeb',
                        path: '/main/portal/server/portal/web',
