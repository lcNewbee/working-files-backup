<?php
class SystemRole_Model extends CI_Model {
    ...
    function Add($data) {        
        ...
        $result = $this->portalsql->insert('portal_role', $insertary);
    ...
    function Delete($data){
        ...
        foreach($dellist as $row) {
            ...
            $result = $this->portalsql->delete('portal_role');
        }     
    ...
    function Edit($data){
        ...
        $result = $this->portalsql->replace('portal_role', $updata);       
