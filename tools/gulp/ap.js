...
// 执行所有列表中的AP编译工作
gulp.task('pub:all', () => {
  runSequence('test', 'pub:AIP5', 'pub:AIP10');
  // runSequence('test', 'pub:AIP5', 'pub:AIP10', 'pub:ASW3', 'pub:AEC120', 'pub:ASC175', 'pub:ASC120', 'pub:AEC60', 'pub:ASC3', 'pub:ASC6', 'pub:ASW120');
});
